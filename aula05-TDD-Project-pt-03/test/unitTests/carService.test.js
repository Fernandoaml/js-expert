...
describe("CarService Suite Tests", () => {
  ...
  it("Should retrive a random position from an array", async () => {
  ...
  it("given a customer and a car category it should return a transaction receipt", async () => {
    ...
    // console.log(now); //2020-11-05T03:00:00.000Z
    // console.log(new Date()); // 2020-11-05T03:00:00.000Z
    ...
    const expected = await new Transaction({
      customer,
      car,
